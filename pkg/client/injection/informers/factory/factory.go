...
import (
	...
	externalversions "github.com/yolocs/gcp-binding/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/yolocs/gcp-binding/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
