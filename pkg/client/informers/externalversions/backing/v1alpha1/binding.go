...
import (
	...
	backingv1alpha1 "github.com/yolocs/gcp-binding/pkg/apis/backing/v1alpha1"
	versioned "github.com/yolocs/gcp-binding/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yolocs/gcp-binding/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/yolocs/gcp-binding/pkg/client/listers/backing/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BackingV1alpha1().Bindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackingV1alpha1().Bindings(namespace).Watch(options)
			},
		},
		&backingv1alpha1.Binding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backingv1alpha1.Binding{}, f.defaultInformer)
}
