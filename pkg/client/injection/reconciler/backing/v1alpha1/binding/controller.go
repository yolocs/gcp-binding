...
import (
	...
	versionedscheme "github.com/yolocs/gcp-binding/pkg/client/clientset/versioned/scheme"
	client "github.com/yolocs/gcp-binding/pkg/client/injection/client"
	binding "github.com/yolocs/gcp-binding/pkg/client/injection/informers/backing/v1alpha1/binding"
...
const (
	defaultControllerAgentName = "binding-controller"
	defaultFinalizerName       = "bindings.backing.google.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	bindingInformer := binding.Get(ctx)
